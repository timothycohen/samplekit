...
- support low-latency, bidirectional communication with websockets?
...
| [Custom Fetch Helper](https://github.com/timothycohen/samplekit/blob/main/sites/samplekit.dev/src/lib/http/client.svelte.ts) | Communication Protocol | Fully defined client requests right next to the server responses                      |
| [Socket.io](https://socket.io/)                                                                                              | Communication Protocol | Low-latency, bidirectional communication                                              |

...
export default {
	...
	"colors": {
		...
		"editorError.border": "#610000",
		"editorWarning.foreground": "#00000000",
		"editorWarning.border": "#614c00",
		"editorInlayHint.background": "#00000000",
		"editorInlayHint.typeForeground": "#94b8b0",
		"editorInlayHint.parameterForeground": "#82b0c9",
		"diffEditor.insertedLineBackground": "#001a00",
		"diffEditor.insertedTextBackground": "#003800",
		"diffEditorGutter.insertedLineBackground": "#003800",
		"diffEditorOverview.insertedForeground": "#003800",
		"diffEditor.removedLineBackground": "#2f0404",
		"diffEditor.removedTextBackground": "#5e0808",
		"diffEditorGutter.removedLineBackground": "#5e0808",
		"diffEditorOverview.removedForeground": "#5e0808",
		"errorLens.errorForeground": "#f2706e",
		"errorLens.errorMessageBackground": "#f2706e1a",
		"errorLens.warningForeground": "#dd8736",
		"errorLens.warningMessageBackground": "#dd87361a",
		"errorLens.infoForeground": "#4fa8e1",
		"errorLens.infoMessageBackground": "#4fa8e11a",
		"errorLens.hintForeground": "#b29e51",
		"errorLens.hintMessageBackground": "#b29e511a",
		...
		"editorBracketHighlight.foreground2": "#db70d8",
		"editorBracketHighlight.foreground3": "#1a9fff",
		"editorBracketHighlight.unexpectedBracket.foreground": "#df2020",
		"editorBracketPairGuide.background1": "#464439",
		"editorBracketPairGuide.background2": "#443c43",
		"editorBracketPairGuide.background3": "#394146",
		"editorBracketPairGuide.activeBackground1": "#7e7b67",
		"editorBracketPairGuide.activeBackground2": "#7a6c79",
		"editorBracketPairGuide.activeBackground3": "#67757e"
	},
	"tokenColors": [
		{
			"scope": [
		...
		{ "scope": ["entity.name.tag.css", "entity.name.tag.less"], "settings": { "foreground": "#d7ba7d" } },
		...
		{ "scope": ["storage.type.function.arrow"], "settings": { "fontStyle": "" } },

...
export const handleErrorWithSentry = sentry.handleErrorWithSentry.bind(sentry);
export const sentryHandle = sentry.sentryHandle.bind(sentry);
export const captureExceptionWithSentry = sentry.captureException.bind(sentry);

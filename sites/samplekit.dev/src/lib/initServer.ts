...
import { getCloudfront } from '$lib/objectStorage/server/cloudfront';
import { getRekognition } from '$lib/objectStorage/server/rekognition';
import { getS3 } from '$lib/objectStorage/server/s3';

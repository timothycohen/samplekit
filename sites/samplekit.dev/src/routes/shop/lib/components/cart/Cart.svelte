<script lang="ts">
	...
	import { RemoveFromCartBtn } from '$routes/shop/lib/components';
	import { useCartCtx } from '$routes/shop/lib/ctx';
	import { DEFAULT_SELECTED_OPTION, formatPrice } from '$routes/shop/lib/utils';

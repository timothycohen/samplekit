<script lang="ts" module>
	...
	export const metadata = {
		...
		srcCodeHref:
			'https://github.com/timothycohen/samplekit/blob/main/sites/samplekit.dev/src/lib/objectStorage/client/cropImgUploadController.svelte.ts',
		description:
...
<!-- shiki-start
```ts
import { objectStorage, CropImgUploadController } from '$lib/objectStorage/client';
...
<p>
	SampleKit uses its
	<a
		href="https://github.com/timothycohen/samplekit/blob/staging/sites/samplekit.dev/src/lib/rateLimit/server.ts"
		data-external
	>
		own rate limiter
	</a>
